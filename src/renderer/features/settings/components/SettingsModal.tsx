...
import { DefaultPromptsSettings } from '../sections/DefaultPromptsSettings';
 ...
 */
type SettingsSectionType = 'General' | 'AI Providers' | 'Default Prompts';
        ...
        <div className="flex flex-row rounded-lg overflow-hidden w-full h-full">
          ...
          <div className="w-64 border-r border-border p-4 flex flex-col">
            ...
            <nav className="flex flex-col gap-1">
              ...
              {renderSidebarItem('AI Providers', <FaMicrochip size={18} />)}
