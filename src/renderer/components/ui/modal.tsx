...
const ModalComponent: React.FC<ModalProps> = ({
  ...
  useEffect(() => {
    ...
    const style: { [key: string]: any } & React.CSSProperties = {
      position: 'fixed',
      width,
      height,
      maxWidth,
